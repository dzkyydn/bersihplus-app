...
import 'donation_receipt_page_model.dart';
export 'donation_receipt_page_model.dart';

class DonationReceiptPageWidget extends StatefulWidget {
  const DonationReceiptPageWidget({
    super.key,
    this.invoiceImage,
  ...
  @override
  State<DonationReceiptPageWidget> createState() =>
      _DonationReceiptPageWidgetState();
}

class _DonationReceiptPageWidgetState extends State<DonationReceiptPageWidget> {
  late DonationReceiptPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DonationReceiptPageModel());
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Text(
                    'Silahkan unduh atau bagikan bukti donasi.  Gunakan tombol kembali untuk pergi ke halaman utama.',
