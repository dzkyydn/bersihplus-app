...
class _SettingPageWidgetState extends State<SettingPageWidget> {
  ...
  void initState() {
    ...
    _model.numberPhoneTextController ??= TextEditingController(
        text: currentUserData?.phone != 'null' ? currentUserData?.phone : '');
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<ApiCallResponse>(
      ...
      builder: (context, snapshot) {
        ...
        final settingPageContactAPIResponse = snapshot.data!;
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            var shouldSetState = false;
                            _model.apiResultPassword =
                                await PasswordAPICall.call(
                              passwordOld:
