              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                      'Silahkan masukkan alamat email yang sudah didaftarkan sebelumnya. Kami akan segera mengirimkan kata sandi baru untuk pemulihan akun.',
                  ...
                  Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        ...
                        _model.apiResultForgot = await ForgotpassAPICall.call(
                          emailAddress: _model.textController.text,
                        );

                        shouldSetState = true;
                        if ((_model.apiResultForgot?.succeeded ?? true)) {
                          ScaffoldMessenger.of(context).clearSnackBars();
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              content: Text(
                                getJsonField(
                                  (_model.apiResultForgot?.jsonBody ?? ''),
                                  r'''$.message''',
                                ).toString(),
